...
% =========================================================================
dias_escolhidos = [8 9 10 11 19]; % dias escolhido s
...
% cria o nome do arquivo que indica quais dias foram extraídos, por exemplo, "matrix_diffTEC_Aug2025_dias_perturbados(aqui entram os dias)"
dias_str = sprintf('%d_', dias_escolhidos);
output_name = ['matrix_diffTEC_Aug2025_dias_perturbados', dias_str(1:end-1), '.txt'];
