...
% Define major ticks
major_ticks = datenum(2025, 8, 21):datenum(2025, 8, 23); % Major ticks from October 12th to 23rd
...
for i = 1:length(files)
    ...
    time = linspace(datenum(2025,8,21), datenum(2025,8,23), length(vtec_data));
    ...
    matrix_diffTEC(:,i)=diff_TEC_norm;
    plot(time, diff_TEC_norm, 'b.-');
