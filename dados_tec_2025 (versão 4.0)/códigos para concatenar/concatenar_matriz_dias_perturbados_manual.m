...
dias_escolhidos = [8 9 10 11 19]; % dias escolhidos com base no site do Kyoto wdc
...
output_folder = 'C:\Users\vikla\Downloads\dados_tec_2025\dados formatados';
if ~exist(output_folder, 'dir')
    mkdir(output_folder);
end

% salva a matriz final em .txt
output_file = fullfile(output_folder, 'matrix_diffTEC_Aug2025_dias_perturbados.txt');
