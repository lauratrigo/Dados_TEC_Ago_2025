...
% idx_remove = ismember(names, {'25MA', 'ABRA', 'CSLO', 'DINO', 'ECAR', 'ESQU', 'GUAY', 'JVCH', 'MGNO', 'MZAU', 'MZGA', 'OJOA', 'RSAL', 'RSAU', 'SANT', 'TUC1', 'UYCO', 'UYAR', 'UYPA', 'UYSA', 'UYSO', 'UYTD'});
...
matrix_list = readmatrix('matrix_diffTEC_Aug2025.txt');
