...
% =========================================================================
dias_escolhidos = [6 7 16 17 28]; % dia escolhido (nesse caso foi o dia do evento)
...
% cria o nome do arquivo que indica quais dias foram extraídos, por exemplo, "matrix_diffTEC_Aug2025_dias_calmos(aqui entram os dias)"
dias_str = sprintf('%d_', dias_escolhidos);
output_name = ['matrix_diffTEC_Aug2025_dias_calmos', dias_str(1:end-1), '.txt'];
