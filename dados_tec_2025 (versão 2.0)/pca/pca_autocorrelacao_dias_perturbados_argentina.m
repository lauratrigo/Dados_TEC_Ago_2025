...
% idx_remove = ismember(names, {'ABRA', 'ALUM', 'CHAC', 'CHOY', 'CSLO', 'DINO', 'ECAR', 'EPGZ', 'GGUA', 'JVCH', 'LROS', 'MGNO', 'MGUE', 'MZAU', 'MZGA', 'OJOA', 'RIO2', 'RSAL', 'RSAU', 'SANT', 'TUC1', 'UYAR', 'UYPA', 'UYSA', 'UYSO', 'UYTD', 'YEMA'});

idx_remove = ismember(names, {'ABRA', 'ALUM', 'CHAC', 'CHOY', 'CSLO', 'DINO', 'ECAR', 'EPGZ', 'GGUA', 'JVCH', 'LROS', 'MGNO', 'MGUE', 'MZAU', 'MZGA', 'OJOA', 'RIO2', 'RSAL', 'RSAU', 'SANT', 'TUC1', 'UNSA', 'UYAR', 'UYPA', 'UYSO', 'YEMA'});
